...
public class ProxyContext
{
    ...
    /// </param>
    public ProxyContext(object? proxiedObject, MethodInfo proxiedMethod, object?[]? parameters)
    {
    ...
    /// but <see cref="ProxyEntry.Invoked" /> event will still be triggered.
    /// Only effective in the invoking stage.
    /// </summary>
    ...
    /// <summary>
    /// Skip the invoker with a returning value.
    /// Both of the <see cref="ProxyEntry.Invoker" /> and <see cref="ProxyEntry.Invoked" /> event
    /// will not be invoked.
    /// Only effective in the invoking stage.
    /// </summary>
    /// <param name="result">Returning value for this invocation.</param>
