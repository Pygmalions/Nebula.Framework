...
public partial class ProxyGenerator
{
    public static class Meta
    {
        ...
        {
            public static readonly Type Class = typeof(ProxyEntry);
            ...
            public static class Methods
            {
                public static readonly MethodInfo Invoke = Class.GetMethod(nameof(ProxyEntry.Invoke))!;
            }
            ...
            public static class Properties
            {
                ...
                {
                    public static readonly PropertyInfo Property = Class.GetProperty(nameof(ProxyEntry.Invoker))!;
        ...
        {
            public static readonly Type Class = typeof(ProxyContext);
            ...
            public static class Properties
            {
                public static class ProxiedMethod
                {
                    public static readonly PropertyInfo Property = 
                        Class.GetProperty(nameof(ProxyContext.ProxiedMethod))!;
                ...
                {
                    public static readonly PropertyInfo Property = 
                        Class.GetProperty(nameof(ProxyContext.ProxiedObject))!;
                ...
                {
                    public static readonly PropertyInfo Property = Class.GetProperty(nameof(ProxyContext.Arguments))!;
            ...
            public static class Methods
            {
                public static readonly MethodInfo Return = Class.GetMethod(nameof(ProxyContext.Return))!;
            }
        }

        public static class ActionContextMeta
        {
            public static readonly Type Class = typeof(Action<ProxyContext>);
